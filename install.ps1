...
Write-Host "1. Put your 'client_secret.json' in: %USERPROFILE%\.config\gws\client_secret.json"
Write-Host "2. Authenticate: cd $ExtractDir; .\bin\gws.exe auth login"
Write-Host "3. Run: .\$AppName.exe"
Write-Host ""
